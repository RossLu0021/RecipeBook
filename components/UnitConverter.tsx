...
export default function UnitConverter({ visible, onClose }: UnitConverterProps) {
    ...
    const convert = (val: string) => {
        ...
        if (category === "Temp") {
            if (fromUnit === "C" && toUnit === "F") return ((num * 9) / 5 + 32).toFixed(1);
            if (fromUnit === "F" && toUnit === "C") return (((num - 32) * 5) / 9).toFixed(1);
            return num.toString();
        }
